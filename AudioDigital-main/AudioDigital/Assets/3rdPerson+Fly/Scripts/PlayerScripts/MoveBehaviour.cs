...
public class MoveBehaviour : GenericBehaviour
{
	...
	[SerializeField] private AudioResource[] footsteps;
	private static MoveBehaviour instance = null;

	public static SurfaceType Surface
    {
		private get => surface;
        set
        {
			...
			surface = value;
			instance.audioSource.resource = instance.footsteps[(int)value];
        }
    }
	private static SurfaceType surface = SurfaceType.GRASS;
